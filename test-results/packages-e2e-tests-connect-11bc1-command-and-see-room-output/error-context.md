...
- Name: packages/e2e/tests/connection.spec.ts >> Connection smoke test >> player can send "look" command and see room output
- Location: packages/e2e/tests/connection.spec.ts:13:7
