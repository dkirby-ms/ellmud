...
export default function SettingsModal({ open, onClose }: SettingsModalProps) {
  ...
  return (
    ...
    >
      <div
        className="bg-bg-primary border-2 border-accent-gold rounded-lg shadow-2xl flex w-[90vw] h-[85vh] max-w-6xl"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Left sidebar - Categories */}
        <div className="w-64 bg-bg-panel border-r border-border-muted p-4">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-accent-gold font-serif text-xl">Settings</h2>
            <button
              onClick={onClose}
          ...
          {isLoading && (
            <span className="text-text-disabled text-xs font-sans mb-2 block animate-pulse">
              Syncing…
            </span>
          )}
          {!isLoading && isSynced && (
            <span className="text-success text-xs font-sans mb-2 block opacity-60">
              ✓ Synced
            </span>
          )}
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="flex items-center gap-4">
                    <input
                      ...
                      className="flex-1"
                    />
                    <span className="text-text-primary w-12 font-mono">
                      {fontSize}px
                    </span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex gap-4">
                    <button className="flex-1 px-4 py-2 bg-bg-elevated border border-accent-gold text-text-primary rounded font-sans">
                      Sidebar Right
                    </button>
                    <button className="flex-1 px-4 py-2 bg-bg-panel border border-border-muted text-text-secondary hover:border-interactive rounded font-sans">
                      Sidebar Left
                    </button>
                  </div>
                </div>
                    ...
                    <label className="flex items-start gap-3 p-4 bg-bg-panel border border-accent-gold rounded cursor-pointer">
                      ...
                      <div className="flex-1">
                        ...
                        <p
                          ...
                          style={{ lineHeight: 1.5 }}
                        >
                          "The chamber is dark, water pooling at your feet.
                    ...
                    <label className="flex items-start gap-3 p-4 bg-bg-panel border border-border-muted rounded hover:border-interactive cursor-pointer">
                      ...
                      <div className="flex-1">
                        ...
                        <p
                          ...
                          style={{ lineHeight: 1.5 }}
                        >
                          "You find yourself in a darkened chamber. Brackish
                          water pools around your boots, cold and still. The
                          walls show signs of ancient stonework, now crumbling.
                          Two passages beckon..."
                        </p>
                      </div>
                    </label>
              ...
              <div className="space-y-3">
                {[
                  ...
                  >
                    ...
                    <div className="px-3 py-1 bg-bg-elevated border border-border-muted rounded text-accent-gold min-w-[40px] text-center font-mono">
                      {bind.key}
                    </div>
                  </div>
                ))}
