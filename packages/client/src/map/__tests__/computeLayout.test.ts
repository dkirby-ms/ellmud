...
describe('computeLayout', () => {
  ...
  // ── 26. Dense city zone — main-street alignment ───────────────────────────
  it('keeps east/west-connected main-street rooms on the same row (dense city)', () => {
    // Dense city topology (52 rooms, ~107 exits). The wall-road branch south
    ...
    const exitData: [string, string, string][] = [
      ['reading-hall', 'east', 'temple'],
      ['temple', 'north', 'altar'],
      ['temple', 'east', 'shrine'],
      ['temple', 'south', 'courtyard'],
      ['temple', 'west', 'reading-hall'],
      ['cleric-sanctum', 'east', 'cleric-lounge'],
      ['cleric-lounge', 'south', 'cleric-entrance'],
      ['cleric-lounge', 'west', 'cleric-sanctum'],
      ['cleric-entrance', 'north', 'cleric-lounge'],
      ['cleric-entrance', 'east', 'courtyard'],
      ['courtyard', 'north', 'temple'],
      ['courtyard', 'east', 'inn-lobby'],
      ['courtyard', 'south', 'plaza'],
      ['courtyard', 'west', 'cleric-entrance'],
      ['inn-lobby', 'north', 'post-office'],
      ['inn-lobby', 'east', 'tavern'],
      ['inn-lobby', 'west', 'courtyard'],
      ['inn-lobby', 'up', 'inn-desk'],
      ['tavern', 'west', 'inn-lobby'],
      ['inn-desk', 'north', 'archive'],
      ['inn-desk', 'down', 'inn-lobby'],
      ['bakehouse', 'south', 'avenue-2'],
      ['outfitter', 'south', 'avenue-3'],
      ['smithy', 'south', 'avenue-4'],
      ['avenue-1', 'north', 'enchanter'],
      ['avenue-1', 'east', 'avenue-2'],
      ['avenue-1', 'south', 'mage-entrance'],
      ['avenue-1', 'west', 'west-gate'],
      ['avenue-2', 'north', 'bakehouse'],
      ['avenue-2', 'east', 'plaza'],
      ['avenue-2', 'south', 'armorer'],
      ['avenue-2', 'west', 'avenue-1'],
      ['plaza', 'north', 'courtyard'],
      ['plaza', 'east', 'avenue-3'],
      ['plaza', 'south', 'commons'],
      ['plaza', 'west', 'avenue-2'],
      ['avenue-3', 'north', 'outfitter'],
      ['avenue-3', 'east', 'avenue-4'],
      ['avenue-3', 'south', 'kennel'],
      ['avenue-3', 'west', 'plaza'],
      ['avenue-4', 'north', 'smithy'],
      ['avenue-4', 'east', 'east-gate'],
      ['avenue-4', 'south', 'fighter-hall'],
      ['avenue-4', 'west', 'avenue-3'],
      ['mage-entrance', 'north', 'avenue-1'],
      ['mage-entrance', 'south', 'mage-lounge'],
      ['mage-lounge', 'north', 'mage-entrance'],
      ['mage-lounge', 'east', 'mage-lab'],
      ['mage-lab', 'west', 'mage-lounge'],
      ['armorer', 'north', 'avenue-2'],
      ['fighter-hall', 'north', 'avenue-4'],
      ['fighter-hall', 'east', 'fighter-lounge'],
      ['fighter-lounge', 'south', 'sparring-yard'],
      ['fighter-lounge', 'west', 'fighter-hall'],
      ['sparring-yard', 'north', 'fighter-lounge'],
      ['back-lane-end', 'east', 'commons'],
      ['back-lane-end', 'south', 'flophouse'],
      ['back-lane-end', 'west', 'back-lane'],
      ['commons', 'north', 'plaza'],
      ['commons', 'east', 'narrow-alley'],
      ['commons', 'south', 'junkyard'],
      ['commons', 'west', 'back-lane-end'],
      ['narrow-alley', 'east', 'wharf-alley'],
      ['narrow-alley', 'south', 'rogue-entrance'],
      ['narrow-alley', 'west', 'commons'],
      ['rogue-entrance', 'north', 'narrow-alley'],
      ['rogue-entrance', 'east', 'rogue-lounge'],
      ['rogue-lounge', 'south', 'hidden-yard'],
      ['rogue-lounge', 'west', 'rogue-entrance'],
      ['hidden-yard', 'north', 'rogue-lounge'],
      ['junkyard', 'north', 'commons'],
      ['kennel', 'north', 'avenue-3'],
      ['enchanter', 'south', 'avenue-1'],
      ['west-gate', 'east', 'avenue-1'],
      ['west-gate', 'south', 'rampart-1'],
      ['west-gate', 'west', 'west-gate-outer'],
      ['east-gate', 'east', 'east-gate-outer'],
      ['east-gate', 'south', 'waterworks'],
      ['east-gate', 'west', 'avenue-4'],
      ['rampart-1', 'north', 'west-gate'],
      ['rampart-1', 'south', 'rampart-2'],
      ['rampart-2', 'north', 'rampart-1'],
      ['rampart-2', 'east', 'back-lane'],
      ['rampart-2', 'south', 'rampart-3'],
      ['back-lane', 'east', 'back-lane-end'],
      ['back-lane', 'west', 'rampart-2'],
      ['wharf-alley', 'east', 'dock-end'],
      ['wharf-alley', 'south', 'wharf'],
      ['wharf-alley', 'west', 'narrow-alley'],
      ['dock-end', 'south', 'old-shed'],
      ['dock-end', 'west', 'wharf-alley'],
      ['rampart-3', 'north', 'rampart-2'],
      ['rampart-3', 'south', 'bridge'],
      ['flophouse', 'north', 'back-lane-end'],
      ['wharf', 'north', 'wharf-alley'],
      ['old-shed', 'north', 'dock-end'],
      ['bridge', 'north', 'rampart-3'],
      ['west-gate-outer', 'east', 'west-gate'],
      ['east-gate-outer', 'west', 'east-gate'],
      ['post-office', 'south', 'inn-lobby'],
      ['archive', 'south', 'inn-desk'],
      ['altar', 'south', 'temple'],
      ['shrine', 'west', 'temple'],
      ['waterworks', 'north', 'east-gate'],
    ];
    ...
    const layout = computeLayout(rooms, 'reading-hall');

    // The entire avenue corridor (east/west chain) should share y,
    // including gate rooms connected E/W to the corridor ends
    const coreStreet = [
      'west-gate-outer', 'west-gate',
      'avenue-1', 'avenue-2', 'plaza',
      'avenue-3', 'avenue-4',
      'east-gate', 'east-gate-outer',
    ];
    const ys = coreStreet.map(id => pos(layout, id).y);
    const misaligned = coreStreet.filter((_, i) => ys[i] !== ys[0]);
    expect(misaligned).toEqual([]);

    // rampart-2 and back-lane are E/W-connected and must share y
    const wr2 = pos(layout, 'rampart-2');
    const pa = pos(layout, 'back-lane');
    expect(wr2.y).toBe(pa.y);

    // mage-entrance is south of back-lane (north exit → back-lane row)
    const mg = pos(layout, 'mage-entrance');
  ...
  // ── 29. Dense city crossing count diagnostic ─────────────────────────────
  it('reduces crossings in dense zones', () => {
    // This test uses a dense city topology to verify crossing reduction.
    ...
    console.log(`Dense city crossings: ${crossings}`);
