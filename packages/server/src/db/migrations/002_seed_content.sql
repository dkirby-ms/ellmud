...
VALUES
  ...
  -- ─── Stronghold ambient NPCs ────────────────────────────────────────────────
  ('kindari-sentinel', 'Kindari Sentinel', 'kindari-sentinel',
   'A Kindari guard in welded-plate armour, tools hanging from their belt, scanning the catwalks with practiced calm.',
   1, 0, 0, 0, 0, 1, 2, '{reliquary-catwalk-junction,reliquary-pipe-corridor,reliquary-loading-dock}', '{}', 8, 15, 1.0,
   '[]'::jsonb,
   false, 'A Kindari guard in welded-plate armour, tools hanging from their belt, scanning the catwalks with practiced calm.', 'published'),
  ('drone-scrap-rat', 'Drone Scrap Rat', 'drone-scrap-rat',
   'A fat grey rat with a circuit-board fragment wedged in its teeth, scurrying between machinery.',
   1, 0, 0, 0, 0, 1, 3, '{reliquary-drone-bay,reliquary-generator-room,reliquary-cistern-access}', '{}', 5, 10, 1.0,
   '[]'::jsonb,
   false, 'A fat grey rat with a circuit-board fragment wedged in its teeth, scurrying between machinery.', 'published'),
  ('preservation-archivist', 'Preservation Archivist', 'preservation-archivist',
   'An elderly Kindari tending the shrine, murmuring inventory counts like prayer.',
   1, 0, 0, 0, 0, 1, 1, '{reliquary-shrine-alcove,reliquary-commons}', '{}', 5, 10, 1.0,
   '[]'::jsonb,
   false, 'An elderly Kindari tending the shrine, murmuring inventory counts like prayer.', 'published'),
  ('pipeline-tech', 'Pipeline Tech', 'pipeline-tech',
   'A Kindari technician checking pipe gauges, wrench in hand, grease on everything.',
   1, 0, 0, 0, 0, 1, 1, '{reliquary-settling-pool,reliquary-infirmary,reliquary-generator-room}', '{}', 5, 10, 1.0,
   '[]'::jsonb,
   false, 'A Kindari technician checking pipe gauges, wrench in hand, grease on everything.', 'published'),
  ('catwalk-lookout', 'Catwalk Lookout', 'catwalk-lookout',
   'A Kindari lookout with binoculars made from drone optics, watching the Siltgate horizon.',
   1, 0, 0, 0, 0, 1, 1, '{reliquary-watchpost,reliquary-upper-catwalk}', '{}', 5, 10, 1.0,
   '[]'::jsonb,
   false, 'A Kindari lookout with binoculars made from drone optics, watching the Siltgate horizon.', 'published'),
  ('bloom-warden', 'Bloom Tender Warden', 'bloom-warden',
   'A Bloom Tender in salt-crusted overalls, spear-gun slung across their back, watching the stairwell with patient eyes.',
   1, 0, 0, 0, 0, 1, 2, '{bloom-leg-stairwell,bloom-cargo-hatch,bloom-platform-descent}', '{}', 8, 15, 1.0,
   '[]'::jsonb,
   false, 'A Bloom Tender in salt-crusted overalls, spear-gun slung across their back, watching the stairwell with patient eyes.', 'published'),
  ('algae-crawler', 'Algae Crawler', 'algae-crawler',
   'A translucent crustacean the size of a cat, feeding on algae scum, its carapace faintly bioluminescent.',
   1, 0, 0, 0, 0, 1, 3, '{bloom-algae-terraces,bloom-kelp-garden,bloom-tidal-pool}', '{}', 5, 10, 1.0,
   '[]'::jsonb,
   false, 'A translucent crustacean the size of a cat, feeding on algae scum, its carapace faintly bioluminescent.', 'published'),
  ('tide-deck-cook', 'Tide Deck Cook', 'tide-deck-cook',
   'A weathered Tender stirring a pot of kelp stew, offering unsolicited opinions about bloom pH levels.',
   1, 0, 0, 0, 0, 1, 1, '{bloom-mess-deck}', '{}', 5, 10, 1.0,
   '[]'::jsonb,
   false, 'A weathered Tender stirring a pot of kelp stew, offering unsolicited opinions about bloom pH levels.', 'published'),
  ('observatory-cartographer', 'Observatory Cartographer', 'observatory-cartographer',
   'A gaunt researcher surrounded by rolled charts, muttering coordinates and marking coastline changes.',
   1, 0, 0, 0, 0, 1, 1, '{bloom-expedition-board,bloom-lens-gallery}', '{}', 5, 10, 1.0,
   '[]'::jsonb,
   false, 'A gaunt researcher surrounded by rolled charts, muttering coordinates and marking coastline changes.', 'published'),
  ('nest-spotter', 'Nest Spotter', 'nest-spotter',
   'A Tender with a brass telescope, scanning the Gulf for approaching vessels and bloom fronts.',
   1, 0, 0, 0, 0, 1, 1, '{bloom-crows-nest,bloom-radio-shack}', '{}', 5, 10, 1.0,
   '[]'::jsonb,
   false, 'A Tender with a brass telescope, scanning the Gulf for approaching vessels and bloom fronts.', 'published'),
  ('krewe-sentinel', 'Krewe Sentinel', 'krewe-sentinel',
   'A masked Krewe guard in painted armour, moving with deliberate theatrical grace, spear tapping the floor in rhythm.',
   1, 0, 0, 0, 0, 1, 2, '{carrion-west-concourse,carrion-east-concourse,carrion-vine-tunnel}', '{}', 8, 15, 1.0,
   '[]'::jsonb,
   false, 'A masked Krewe guard in painted armour, moving with deliberate theatrical grace, spear tapping the floor in rhythm.', 'published'),
  ('parade-rat', 'Parade Rat', 'parade-rat',
   'A bold rat wearing a tiny scrap of gold fabric, nesting in the debris of old parades.',
   1, 0, 0, 0, 0, 1, 3, '{carrion-prop-graveyard,carrion-locker-passage,carrion-tunnel-of-masks}', '{}', 5, 10, 1.0,
   '[]'::jsonb,
   false, 'A bold rat wearing a tiny scrap of gold fabric, nesting in the debris of old parades.', 'published'),
  ('incense-keeper', 'Incense Keeper', 'incense-keeper',
   'A robed Krewe elder tending braziers, smoke curling from resin chips, dispensing cryptic medical advice.',
   1, 0, 0, 0, 0, 1, 1, '{carrion-incense-hall,carrion-infirmary}', '{}', 5, 10, 1.0,
   '[]'::jsonb,
   false, 'A robed Krewe elder tending braziers, smoke curling from resin chips, dispensing cryptic medical advice.', 'published'),
  ('drum-caller', 'Drum Caller', 'drum-caller',
   'A young Krewe performer beating a rhythm on salvaged steel drums, setting the Dome''s pulse.',
   1, 0, 0, 0, 0, 1, 1, '{carrion-drum-circle,carrion-rain-stage}', '{}', 5, 10, 1.0,
   '[]'::jsonb,
   false, 'A young Krewe performer beating a rhythm on salvaged steel drums, setting the Dome''s pulse.', 'published'),
  ('scaffold-rigger', 'Scaffold Rigger', 'scaffold-rigger',
   'A Krewe worker in harness and paint-stained coveralls, maintaining the Dome''s precarious stage infrastructure.',
   1, 0, 0, 0, 0, 1, 1, '{carrion-upper-bowl,carrion-scaffold-bridge,carrion-rain-stage}', '{}', 5, 10, 1.0,
   '[]'::jsonb,
   false, 'A Krewe worker in harness and paint-stained coveralls, maintaining the Dome''s precarious stage infrastructure.', 'published')
