...
CONSOLIDATED INBOX ENTRIES TO APPEND TO decisions.md

---

## 2026-04-14T00:02:00Z: Combat Stat System Phase 1 — 8-Stat Weapon-Skill Architecture

**By:** Jarlaxle (Game Systems Dev), Drizzt (Engine Dev), Regis (Frontend), Minsc (QA), Elminster (Architecture Review)  
**Date:** 2026-04-13  
**Status:** Implemented and approved for merge  
**Scope:** Core combat stats redesign, DB migrations, test coverage, UI display

### Executive Summary

Replaced 5-stat model (maxHp/attack/defence/armour/agility) with unified 8-stat weapon-skill model deployed across players, creatures, and game systems. All agent deliverables complete: DB migrations (018+019), CombatStats interface, damage formula (dodge→shield block→armour resolution), 66 new tests (all passing), UI display (StatusPanel Combat Skills section), and type safety (0 TS errors across 3088 tests).

### New 8-Stat Model

**All stats (shared players/creatures):**
- `maxHp` — Health points
- `unarmed` — Bare-fist attack skill (rank 1-10)
- `oneHanded` — One-handed weapon skill (rank 1-10)
- `twoHanded` — Two-handed weapon skill (rank 1-10)
...
## Archived from `.squad/decisions.md` on 2026-06-23

Undated legacy topology analysis archived during the decisions size gate because `decisions.md` exceeded 20 KiB and the entry predates the current 2026-06 deploy decisions.
