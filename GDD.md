...
## Genre
Real-Time Multiplayer MUD/MMORPG · Zone-Based Exploration · Permadeath

## Core Fantasy
You are an **individual** in a vast world of adventure filled with danger and exotic things great and small. Venture into dangerous, hand-crafted zones filled with hostile creatures, environmental hazards, and other adventurers. Scavenge valuable artifacts, master combat, and survive encounters. If you fall, your gear is lost, but your legend lives on in the Hall of Fame. Every excursion is a calculated risk. Every encounter has stakes. Permadeath makes every decision matter.

## Platforms
**Web Client** (React + Vite) — Text-primary interface with modern UI components, compass navigation, and styled terminal output. Accessible by design.  
**Unity Client** (Standalone) — Full 3D graphics, isometric or third-person perspective, same gameplay as web client. Cross-platform desktop support.

Both clients connect to the same persistent world via WebSocket. The server is agnostic to client type — gameplay is identical whether you play via browser or thick client.

## Target Audience
- Players who grew up on classic MUDs and MMORPGs (EverQuest, World of Warcraft, Ultima Online) and miss the sense of risk, discovery, and persistent consequence
- Fans of roguelikes and permadeath games who want a persistent multiplayer world
- Tabletop RPG players and interactive fiction enthusiasts who enjoy rich narrative and emergent storytelling
- Builders and content creators who want to design zones and encounters in a live, shared world
- Anyone seeking a modern take on the MUD/MMORPG formula with high-stakes consequences and meaningful progression

---

# 1. HIGH-LEVEL VISION

**Ellmud** is a real-time multiplayer MUD/MMORPG where death is permanent and progression is earned through exploration and combat. Players spawn in their **faction's stronghold**, a persistent hub where they manage gear, prepare for adventures, and socialize with other faction members.
From there, they venture into **dangerous hand-crafted zones** — diverse environments designed for exploration, tactical combat encounters, and the thrill of discovery and survival.

Each zone is a **designed experience**: permanent room layouts, deliberate encounter placement, environmental storytelling, and authored narrative beats. These are traditional MUD/MMORPG-style areas where players encounter both creatures and other adventurers. Death is permanent and costly — when you fall, your equipped gear is dropped for others to claim. This creates meaningful risk and reward. You learn zones over multiple visits, and other players encountered within them become part of the living world.
...
All player-facing text is enriched by an **LLM that narrates the world**, but **the world itself is deterministic and server-authoritative**.
The LLM is a *lens*, not a *game engine*.

### Design Pillars
1. **Tension through meaningful consequence.** Permadeath raises the stakes. Every decision carries weight. Loss is possible and real.
2. **World-first design.** Zones, encounters, and NPCs are authored and deterministic. The world exists independent of player presence. Other players are part of the world, not obstacles.
3. **Emergent narrative.** The LLM weaves flavour around mechanical truth, making every encounter feel unique even when underlying events are similar.
4. **Respect for the player's time.** Adventures span 30-120 minutes depending on ambition. Preparation is quick. Death stings but doesn't erase weeks of progress.
...
# 8. MULTIPLAYER INTERACTION & EMERGENT PvP

*(Note: PvP is an emergent consequence of shared-world zones, not a designed-for system. PvP mechanics are minimal and underfocused. Future work prioritizes PvE content expansion and alternative social dynamics.)*

Zones are **shared-world spaces** where PvE and PvP can emerge naturally. Because other players are part of the world and zones are persistent, conflict is possible. When it occurs, the **same combat system** used against creatures applies (§6). There is no separate PvP mode, special arena, or alternate damage formula.
...
- **Multiple zone exits.** Zone exits are distributed throughout the map to prevent single-chokepoint ambushes at exit points (exit camping).
