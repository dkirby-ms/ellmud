We're going to realign the game universe and setting. 

Basic setting: Dystopian Earth future, set in the United States Gulf South coast of Louisiana and Mississippi. A future where homo sapiens sapiens has gone extinct, replaced by mutant organisms that betray their human ancestry in the worst ways: corruption, ugliness, gluttony, greed, murder, lust. 

World history: Sometime in 2026, with US currency destablized riots and local rebellions rampant, oligarchs united their remaining power through a corrupt and rumored "Satanic" pact to attempt to eliminate working people and useless freeloading poor hordes to save themselves and the extreme levels of consumption and disproportionate resource expenditure they had grown accustomed to. 
...
On the gulf coast of the United States, a mutant algae strain has bloomed and released a plume of chemical off-gassing, which happens to be the same chemical signature as required to reverse the pickling urns. 

Now, new player characters in the game are "waking up" from such hibernation and into the dystopian future. 

Siltgate, our existing zone, is the new name for what was New Orleans, which has now been drastically altered due to the effects of the Mississippi River shifting west into the Atchafalaya. 

We will need to update the zone flavor text (room names/descriptions) to match the new setting. This seems like work for Laeral and Bruenor. Any questions before we get started?

---

# THEMATIC REALIGNMENT: WORLD DESIGN
...
**Faction Flavor:**
- Pragmatic, methodical, and reverent toward the past
- Speak in technical terms ("That drone chassis is corroded beyond recovery," "Check the filtration manifold")
- Value function over form — everything must *work*
- Distrustful of the "rewilded" world — they see the planet's recovery as a hostile takeover
...
**Updated Room Names & Descriptions (sample — full revision required):**

*Market Quarter (Entry Zone):*
- **market-square** → "You stand in what was once Jackson Square. The statue at its center is gone, toppled and half-buried in silt. Market stalls built from scrap metal and salvaged tarps cluster around the plaza. The smell of cooking fish mingles with rust and brackish water."
- **city-gate** → "A section of collapsed interstate overpass forms an accidental gate, its concrete slabs leaning together like a broken arch. Vines crawl through the rebar. Beyond the threshold, the ruins sprawl — flooded, overgrown, and waiting."

*Silver Arcade → Highrise Ruins:*
- **silver-arcade-1** → "The lobby of a collapsed luxury hotel stretches before you, its marble floors cracked and pooled with rainwater. Chandeliers hang askew, crusted with rust. Balconies above are choked with kudzu."

*Dockward → Causeway District:*
- **wharf-street-1** → "A raised causeway built from salvaged shipping containers runs above the flooded streets. Rust stains streak the metal walls. Below, murky water laps at submerged storefronts."

*Beggar's Span → The Silt Flats:*
- **narrow-alley-1** → "A gap between two tilting townhouses, knee-deep in silted water. Mosquitoes cloud the air. Something moves beneath the surface — ripples spreading outward."

*Ashgate Wastes → The Drone Fields:*
- **rubble-street-1** → "The street is a graveyard of machines. Combat drones lie half-buried in mud, their optical sensors dark, their weapon mounts corroded open like mouths. Spanish moss hangs from their rotors."

*Drowned Veins → The Undercity:*
- **sewer-tunnel-1** → "A flooded drainage tunnel, its ceiling just above water level. The current is slow but persistent. Things skitter along the walls — rats, roaches, or something worse."

**Environmental Notes:**
- Flooded streets (knee-deep to waist-deep water in lower areas)
- Rusted drone debris scattered throughout (narrative flavor, some rooms have lootable components)
- Overgrown vegetation (kudzu, spanish moss, mangroves creeping into urban spaces)
- Wildlife hazards (mutant rats, snakes, swarms of insects)
- The oppressive Gulf humidity — everything is damp, rusted, or rotting

---

### 2.2 THE WARRENS (Tier 1 Dungeon)
...
**Updated Room Names & Descriptions (sample):**

*Entry Zone:*
- **shattered-gate** → "A collapsed drainage grate yawns open, its iron bars bent outward as if something clawed its way *out*. Concrete rubble spills into the tunnel below. The smell of mildew and rat musk rises from the dark."

*Main Tunnels:*
- **rubble-boulevard** → "A maintenance corridor choked with debris — shattered tiles, rusted pipes, and the skeletal remains of pre-extinction machinery. Rat droppings cover every surface."
- **hollow-market** → "A junction where four tunnels converge, forming a chamber large enough to stand upright. Rats have piled refuse here — gnawed bones, shredded plastic, and stranger things."

*Deep Zones:*
- **broken-sanctuary** → "A flooded pump room, its machinery long dead. Water drips from cracked pipes overhead. Something large has been nesting here — you can smell it."

*Boss Area:*
- **dustfall-extraction** → "The tunnel opens into a vertical shaft, its walls lined with rusted ladder rungs. Daylight filters down from above — pale, green-tinged, and promising escape. But the floor is carpeted with rat bones."

**Creature Re-themes:**
- **Gutterspawn** → Mutant rats (size of dogs, aggressive, hunt in packs)
- **Rubble Scavenger** → Giant roaches (armored, fast, disgusting)
- **Hollow Stalker** → Sewer snake (mutant water moccasin, venomous)
- **Boss** → The Rat King (a horrific fusion of dozens of rats, tangled together, moving as one)

---

## 3. WORLD TEXTURE

### 3.1 The Drone Swarms

The combat drones that ended humanity are everywhere now — scattered across the landscape like mechanical corpses. Most are grounded, their batteries dead, their joints seized with rust. But they are *everywhere*:

- Aerial drones hang in trees, caught in vines, wings corroded into lace
- Tracked assault drones lie on their sides in streets, turrets frozen skyward
...
A thousand years of unchecked evolution has created dangerous, oversized, and chemically-adapted species:

- **Rats:** Dog-sized, aggressive, hunt in packs, nest in the Warrens
- **Cockroaches:** Plate-sized, armored, nearly impossible to kill
- **Snakes:** Water moccasins and cottonmouths, grown huge, venomous
- **Spiders:** Orb weavers the size of dinner plates, webs like steel cable
- **Mosquitoes:** Swarms thick enough to obscure vision, carry disease
- **Alligators:** Massive, lurking in flooded streets and bayous
- **Feral hogs:** Tusked, aggressive, territorial
- **Algae blooms:** The mutant strain that woke the urns — produces chemical off-gassing, glows faintly green at night

**Wildlife is useful, not friendly.** Nature is indifferent. Animals don't care about humans — they are neither allies nor enemies, just wildlife following survival instincts. However, some species produce valuable materials or have exploitable behaviors:

- **Giant spider silk** — harvested from webs, used for crafting ropes, nets, and light armor reinforcement
- **Bioluminescent algae** — cultivated or harvested from bloom zones, used for light sources and navigation markers
- **Alligator hide** — tough material for crafting armor, water-resistant gear
- **Snake venom sacs** — alchemical ingredient for poisons, antidotes
- **Rat meat and bones** — desperate-times sustenance, crafting materials for tools
- **Mosquito chitin** — when collected in quantity, used for lightweight armor plating
- **Feral hog tusks** — weapon components, trade goods

Some wildlife behaviors can be exploited by clever players — alligators avoid certain chemical scents, spiders can be lured into blocking passages, rat packs can be baited toward enemies — but these are tactical opportunities, not "taming" or "friendship." The ecosystem is a resource to be used, not a companion to be befriended.

### 3.3 Recognizable Remnants

The old world is visible, but transformed:

- The **Superdome** is a collapsed shell overgrown with vines, its roof caved in
- **Interstate overpasses** form accidental bridges and gates, rusted and skeletal
- **Streetcars** lie on their sides, half-buried, homes for rats and snakes
- **Bourbon Street** is a flooded canal, its neon signs dark and dangling
- **Oak trees** draped in spanish moss still line some streets — the longest-lived witnesses
- **Graveyards** are flooded, their crypts cracked open, bones scattered
- **The levees** failed long ago; the Gulf has reclaimed the delta

Players who know New Orleans will recognize the bones of the city. Players who don't will see a drowned ruin with hints of grandeur.

### 3.4 The Feel of the World

**Oppressive but alive.** The Gulf Coast is not a barren wasteland — it's *overgrown*, humid, buzzing with insect life, choked with vegetation. The apocalypse was a thousand years ago; nature has *won*. Humanity is the intruder now.

**Gritty, textured, lived-in.** Everything is rusted, silted, or rotting. Water is everywhere — pooled in streets, dripping from ceilings, seeping through walls. Metal corrodes. Fabric mildews. Nothing stays clean.

**Eerie, not grimdark.** The world is dangerous, but not *evil*. The drones are dormant. The wildlife is just wildlife — dangerous because it's wild, not because it's malevolent. The factions bicker but they're not at war. There's a weird, fragile hope here — humanity survived, and maybe it can survive again.

**Louisiana flavor is KEY:**
- Brackish water, bayou mud, saltwater spray
- Spanish moss, kudzu, mangroves
- Hurricane-damaged architecture
- Creole/Cajun cultural ghosts (street names, building styles, food references)
- The *humidity* — everything is damp, sticky, oppressive
- The *light* — filtered through haze, reflecting off water, green-tinted by algae
...
You wake in darkness, suspended in liquid. Your lungs burn. The brine tastes of salt and chemicals. Something is *wrong* — the urn was supposed to preserve you indefinitely, but now it's changing. The preservative is breaking down, releasing you.

The urn cracks. Brine spills out. You gasp, choking on air that tastes like rot and growth. Your muscles don't work. You collapse into mud.

**What you remember:**
- The year 2026-2028 (the collapse, the drones, the decision to enter the urn)
- Your name, fragments of your life, the face of someone you loved (all hazy, distorted by time)
- The instructions: "Wait for the enzyme. Someone will come for you."

**What you don't know:**
- How long you've been asleep
- Where you are (the landscape has changed)
- If anyone else survived
- Why the urn opened *now*

You wake alone, disoriented, in a world that has moved on without you.
...
## 5. DESIGN NOTES & RESOLVED QUESTIONS

**Tone Calibration:**
- Avoid zombie/undead tropes (the preserved humans are *alive*, just ancient)
- Avoid "nature is evil" tropes (the planet recovered; it's not hostile, just indifferent)
- Avoid cartoonish Fallout-style humor (this is Louisiana gothic, not 1950s Americana)

**Language Choices:**
- Use "Sleepers" for newly awakened players (in-world term)
...
## 6. MUTANT HUMAN DESCENDANTS

Homo sapiens went extinct. But not all humans entered the urns.

The last desperate survivors — those who couldn't afford urns, who refused to trust the technology, or who fought to the bitter end — lived through the drone wars, the famines, and the ecological collapse. Over 30-40 generations, with extreme selective pressure, radiation exposure from drone weapon residue, and chemical contamination from the mutant algae and other environmental factors, they diverged.

They are no longer human. They are *post-human* — organisms that evolved from homo sapiens stock but took a different path. They look vaguely human, but everything is wrong. Proportions are off. Features are exaggerated. Behaviors are alien.

**They are NOT zombies.** They are alive, breathing, thinking creatures. They eat, breed, fight for territory. But they are not friendly. They are not allies. To them, a waking Sleeper is just another intruder.

### 6.1 What Are They?

Mutant descendants are a divergent evolutionary branch. Some are solitary hunters. Some form crude tribal groups. All of them have adapted to the rewilded Gulf Coast in ways that Sleepers have not — they know the territory, they know the dangers, and they see newly awakened humans as *prey*.

They betray their human ancestry "in the worst ways" — each archetype embodies a dark aspect of humanity, stripped of civilization's constraints and amplified by mutation.

### 6.2 Archetypes

**The Graftlords (Corruption)**
- **Appearance:** Bloated, asymmetrical figures draped in salvaged scrap metal and corroded jewelry. Their skin is mottled gray-green, stretched over distended frames. Multiple vestigial limbs sprout from their backs — useless, twitching.
- **Behavior:** Territorial hoarders who claim sections of ruins as "kingdoms." They force other mutants into servitude through intimidation and violence. They wear the trappings of authority — rusted badges, tattered uniforms, improvised crowns — but their rule is pure dominance.
- **Habitat:** Flooded government buildings, collapsed courthouses, old police stations. Anywhere that once represented power.
- **Design Note:** They *remember* hierarchy, even if they don't understand it. A Graftlord wearing a corroded sheriff's badge, sitting on a throne made of overturned desks, is the visual target. Authority as cargo cult.

**The Maw-Kin (Gluttony)**
- **Appearance:** Hunched, grotesquely obese figures with distended jaws that unhinge like snakes. Their teeth are rotted stumps, their breath reeks of decay. They move on all fours despite having upright posture — their weight makes bipedal movement difficult.
- **Behavior:** Obsessive scavengers and cannibals. They hoard food — rotting meat, preserved rations, anything edible — in reeking larders. They attack in frenzied rushes when hungry, which is always.
- **Habitat:** Flooded restaurants, grocery store ruins, warehouses. Anywhere food was stored.
- **Design Note:** Gluttony without restraint. They eat until they can't move, then eat more. The horror is in the *desperation* — hunger so deep it became genetic.

**The Bone-Tithes (Greed)**
- **Appearance:** Gaunt, skeletal figures with elongated fingers and sunken eyes. Their skin is waxy, tight over bone. They wear scavenged tech like jewelry — circuit boards as necklaces, drone optics as amulets — and guard their hoards with manic violence.
- **Behavior:** Compulsive thieves and killers. They steal anything shiny, functional, or rare. They set traps around their lairs and ambush scavengers. They don't use what they steal — they just *possess* it.
- **Habitat:** Collapsed banks, jewelry stores, vault ruins. Anywhere wealth was kept.
- **Design Note:** Greed as disease. They'll kill you for a corroded coin. The visual is Gollum meets grave robber — hunched, possessive, paranoid.

**The Render-Kin (Murder/Violence)**
- **Appearance:** Muscular, scarred figures with elongated limbs and fingers tipped with thick, yellow nails like claws. Their eyes are too far apart, their jaws jut forward. They move with predatory grace.
- **Behavior:** Apex hunters. They stalk prey for days, learning patterns, then strike with overwhelming violence. They don't just kill for food — they kill for *pleasure*. They leave mutilated corpses as territorial markers.
- **Habitat:** Dense swamps, flooded tunnels, anywhere with cover for ambush.
- **Design Note:** Violence as instinct. They're what humans would be if we removed empathy and added claws. Fast, smart, and cruel.

**The Fester-Thralls (Ugliness/Body Horror)**
- **Appearance:** Misshapen, asymmetrical creatures covered in weeping sores and tumorous growths. Some have extra limbs, some have fused fingers, some have faces that look melted. No two are alike — mutation has run wild.
- **Behavior:** Shambling, diseased, desperate. They cluster in the darkest corners of ruins, avoiding light. They are not aggressive unless cornered, but their mere presence spreads infection.
- **Habitat:** Sewers, flooded basements, the deepest parts of the Warrens.
- **Design Note:** The visual is body horror meets tragic monster. They were human once. You can see it in the shape of a hand, the curve of a spine. But everything went wrong.

**The Rut-Callers (Lust/Obsession)**
- **Appearance:** Lean, feral figures with exaggerated sexual characteristics — overdeveloped musculature, distended features. They emit pheromonal signals that attract others of their kind. Their eyes are wide, unblinking, manic.
- **Behavior:** Obsessively territorial during mating cycles. They mark territory with chemical scent markers and attack intruders with frenzied violence. Outside mating season, they're skittish and avoid contact.
- **Habitat:** Ruined residential areas, old apartment complexes, flooded bedrooms.
- **Design Note:** Lust as biological imperative, stripped of romance or connection. They are animals in heat, dangerous and unpredictable. The horror is in the *distortion* of something recognizably human.

### 6.3 Naming Convention

Use corrupted bayou creole, local slang, or distorted English:
- **Graftlords** — "the Crowned," "Rust Kings"
- **Maw-Kin** — "Gluttons," "the Reeking"
- **Bone-Tithes** — "Hoarders," "Vault-Wraiths"
- **Render-Kin** — "Stalkers," "the Clawed"
- **Fester-Thralls** — "the Rotted," "Sore-Touched"
- **Rut-Callers** — "the Fevered," "Scent-Marked"

NPCs might refer to them collectively as "the Changed," "the Twisted," or simply "them things in the ruins."

### 6.4 Design Guideline: The Uncanny Valley

These creatures are DEEPLY UNSETTLING because they are *almost* human. They walk on two legs (mostly). They have five fingers (usually). They have something like a face. But every proportion is wrong. Every behavior is alien.

When describing them in room text or combat narration:
- Focus on the *distortion* — "Its fingers are too long, the knuckles bend wrong."
- Emphasize the *recognition* — "You see the shape of a human skull beneath the tumorous growths."
- Use sensory horror — smell (rot, pheromones), sound (wet breathing, clicking joints), movement (twitching limbs, unnatural gait)

These are not fantasy monsters. They are what we became when civilization fell and evolution kept going without us.

---

## 7. THE WIDER WORLD: SETTLEMENTS BEYOND SILTGATE
...
**The World Extends:**
Siltgate is where the player starts, but it's not the only place that matters. Other settlements will be introduced over time — first as destinations for caravans and expeditions, later as explorable zones. The Gulf Coast is dotted with survivors, each cluster adapting in its own way.

For now, leave hooks. Don't define the settlements in detail. Let the world feel lived-in and larger than what the player can see.

---

## 8. ECONOMY: POTABLE WATER

The currency of the post-extinction Gulf Coast is not coins, tokens, or credits. It is **potable water** — clean, drinkable, uncontaminated water. In a world drowning in brackish tide, silted runoff, and algae-choked flood, the one thing everyone needs is the one thing almost no one has.

This is survival economics, not fantasy gold. Inspired by *Caves of Qud*'s dram-based water economy, our system uses water as a currency that is heavy, consumable, and universally necessary.

### 8.1 WHY WATER?

**The Gulf Coast is drowning in water — but none of it is safe to drink.**
...
- **It's heavy.** Water weighs what water weighs. Carrying your wealth means carrying physical mass. This creates genuine tension between prosperity and mobility — the richest scavenger in Siltgate is also the slowest. You cannot hoard wealth without consequence. (This is the *Caves of Qud* weight mechanic: currency has encumbrance.)
- **Everyone needs it.** Water is not abstract value. It is survival. Every faction, every Sleeper, every NPC in the settlement needs clean water to live. Its worth is not agreed upon by convention — it is demanded by biology. There is no "Why would I want gold?" problem. Everyone wants water.
- **It's consumable.** You can *drink your savings*. A desperate player bleeding out in the Warrens can crack open their water supply and drink to survive — but that's tomorrow's rent, tomorrow's trade goods, tomorrow's passage fee gone. This desperation mechanic does not exist with abstract currency. Spending water *hurts* because you are spending something your body needs.
- **It ties to the setting.** The Gulf Coast's real-world history is defined by water problems — brackish infiltration, contamination, hurricane flooding, saltwater intrusion into freshwater aquifers, the impossibility of desalination at scale. Our economy is a direct reflection of the world it exists in.
...
- **50 draws** — a comfortable reserve; what a cautious scavenger carries into the Warrens
- **100+ draws** — serious wealth; you are now visibly encumbered

Draws are carried in skins, canteens, salvaged bottles, and sealed containers. The container matters — an unsealed vessel loses water to evaporation and contamination. High-quality watertight containers are valuable gear in their own right.

### 8.3 WEIGHT AND ENCUMBRANCE

Water is heavy. One draw weighs approximately what you'd expect a cup of water to weigh. This is not negligible.

**The wealth-mobility tension:**
- A player carrying 20 draws for a Warrens run is carrying survival supplies. Manageable.
...
- Do I extract now with 40 draws, or push deeper and risk losing everything?
- Do I stash water at the faction cistern, or keep it on me for emergencies?

### 8.4 STORAGE: FACTION CISTERNS
...
### 8.7 FACTION RELATIONSHIPS TO WATER
...
**Water is survival. Spending water feels REAL.**

When a player pays 10 draws for an inn room, they are not spending an abstract number. They are handing over a day's worth of drinking water for a bed. That transaction has weight — literal and narrative. Write it that way.

- *"You count out ten draws into the innkeeper's measure. She pours them into the house cistern without ceremony. A day's water for a night's rest. Fair enough — if you don't think about it too hard."*

**"Water poor" is genuine desperation, not just "can't buy gear."**

A player with zero draws is not just broke. They are *thirsty*. They are one bad day from dehydration in Gulf heat. "Water poor" means rationing sips, begging at faction cisterns, or drinking brackish and hoping you don't get sick.

- *"Your canteen is empty. The puddle at your feet is brown, still, and smells of rust. You know better. But your tongue is cracked and the heat is relentless."*

**Rich players are literally heavier.**

A wealthy scavenger doesn't jingle with coins — they slosh. Their pack is heavy with sealed containers. They move slower. They're a target. Wealth is visible, audible, and physically burdensome.
...
- **Same Louisiana gothic tone.** The water economy is part of the setting, not bolted on. Write about water the way you write about the humidity, the ruins, the brackish tide — it's *there*, it's oppressive, and it shapes everything.
- **Keep it grounded.** This is survival economics. No one calls draws "currency" in-world. They say "water," "clean water," "drinks," "a day's worth." The language is practical and desperate.
- **Reference real Gulf Coast water problems.** Brackish infiltration from the Gulf. Saltwater intrusion into freshwater tables. Chemical contamination from industrial runoff. The impossibility of large-scale desalination without functioning infrastructure. These are real problems that define our fictional economy.
- **Water descriptions should be sensory.** Clean water is clear, cool, tasteless. Brackish water is brown, warm, salty. Contaminated water shimmers with algae, smells of chemicals. The difference between potable and poison is visible, and players should feel it in room text and item descriptions.
- **Avoid fantasy currency language.** No "coffers," no "treasury," no "fortune in gold." Use "cisterns," "reserves," "stores," "supply." The vocabulary is practical, not regal.

### 8.10 IMPLEMENTATION NOTES

> **For the backend team (Bruenor / Drizzt):** Migration 016 added a `gold` column to the `characters` table. This column should be renamed to `water` (or `draws`) in a future migration to align with the potable water economy. The inn rest cost (currently 10 gold for non-faction guests) becomes 10 draws. All references to "gold" in game logic, commands, and UI should be updated to reference water/draws. This is a naming change — the underlying integer column and mechanics remain the same.

---

**STATUS:** Second draft, updated with resolved design decisions and expanded world content.